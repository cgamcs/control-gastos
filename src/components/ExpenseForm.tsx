    ...
    <form className="space-y-3" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          type="text"
          name="expenseName"
          className="bg-[#383939] p-2 rounded-md"
      ...
      <div className="flex flex-col gap-2">
        ...
        <DatePicker
          className="bg-[#383939] p-2 border-0 rounded-md"
          value={expense.date}
      ...
      <input
        type="submit"
        className="bg-indigo-600 cursor-pointer text-white font-bold rounded-lg w-full p-2 uppercase"
